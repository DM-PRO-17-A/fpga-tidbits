...
bool Run_FullyConnected(WrapperRegDriver * platform) {
    TestFullyConnected fc(platform);
    ...
    */
    ...
    cout << "Result 1: " << int(fc.get_output_data_0()) << endl; //". Expected: " << result0 << endl;
    cout << "Result 2: " << int(fc.get_output_data_1()) << endl; //". Expected: " << result1 << endl;
    cout << "Result 3: " << int(fc.get_output_data_2()) << endl; //". Expected: " << result2 << endl;
}
